...
render() {
const {image, name, model, length, consumables, statusResponse, errorMessage} =this.state;
return  <div className='starships_wrap'>
            <div className='starships_container'>
                <button className='starships_button' onClick={this.getStarshipsData}>NEXT</button>
                {statusResponse === 200 ?
                <div className='starships_container_flex'>
                    ...
                    <ul className='starships_data_list'>
                        ...
                        <li className='starships_data_list_element'>Length: {length}</li>
                        <li className='starships_data_list_element'>Consumables: {consumables}</li>
                    </ul>
                </div> 
                : errorMessage}
            </div>
